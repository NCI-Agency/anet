...
public class FutureEngagementWorkerIT {
    ...
    public static void setUpClass() throws Exception {
        executeEmailServerTests = Boolean.parseBoolean(AnetITConfiguration.getConfiguration().get("emailServerTestsExecute").toString()); 
    ...
    private void testFututeEngagementWorker(int expectedCount) throws Exception {
        // DB integration
        engine.getEmailDao().deletePendingEmails(engine.getEmailDao().getAll().stream()
