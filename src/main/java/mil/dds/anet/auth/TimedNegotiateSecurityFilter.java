...
public class TimedNegotiateSecurityFilter extends NegotiateSecurityFilter {
	...
	public TimedNegotiateSecurityFilter(MetricRegistry metricRegistry) {
		...
		this.timerSetPrincipalFormat = metricRegistry.timer(MetricRegistry.name(this.getClass(), "setPrincipalFormat"));
		this.timerGetPrincipalFormat = metricRegistry.timer(MetricRegistry.name(this.getClass(), "getPrincipalFormat"));
		this.timerSetRoleFormat = metricRegistry.timer(MetricRegistry.name(this.getClass(), "setRoleFormat"));
		this.timerGetRoleFormat = metricRegistry.timer(MetricRegistry.name(this.getClass(), "getRoleFormat"));
		...
		this.timerIsAllowGuestLogin = metricRegistry.timer(MetricRegistry.name(this.getClass(), "isAllowGuestLogin"));
		this.timerSetImpersonate = metricRegistry.timer(MetricRegistry.name(this.getClass(), "setImpersonate"));
		this.timerIsImpersonate = metricRegistry.timer(MetricRegistry.name(this.getClass(), "isImpersonate"));
		this.timerGetProviders = metricRegistry.timer(MetricRegistry.name(this.getClass(), "getProviders"));
	}
