...
public class ReportSearchBuilder {
  ...
  public void addDateClause(Instant queryDate, Comparison comp, String fieldName,
      String parameterName) {
    if (queryDate != null) {
      whereClauses
          .add(String.format(DEFAULT_WHERE_FORMAT, fieldName, comp.getOperator(), parameterName));
