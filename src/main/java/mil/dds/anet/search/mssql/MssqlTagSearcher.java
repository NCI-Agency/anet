...
public class MssqlTagSearcher extends AbstractSearcher implements ITagSearcher {

  @InTransaction
  @Override
  public AnetBeanList<Tag> runSearch(TagSearchQuery query) {
    final MssqlSearchQueryBuilder<Tag, TagSearchQuery> qb =
        new MssqlSearchQueryBuilder<Tag, TagSearchQuery>("MssqlTagSearch");
