...
public class SubscriptionUpdate extends AbstractAnetBean {
	...
	public CompletableFuture<Subscription> loadSubscription(@GraphQLRootContext Map<String, Object> context) {
		if (subscription.hasForeignObject()) {
			return CompletableFuture.completedFuture(subscription.getForeignObject());
		}
		return new UuidFetcher<Subscription>().load(context, "subscriptions", subscription.getForeignUuid())
				.thenApply(o -> { subscription.setForeignObject(o); return o; });
	}
	...
	public CompletableFuture<SubscribableObject> loadUpdatedObject(@GraphQLRootContext Map<String, Object> context) {
		...
		return new UuidFetcher<AbstractAnetBean>().load(context, updatedObjectType, updatedObjectUuid)
				.thenApply(o -> { updatedObject = (SubscribableObject)o; return updatedObject; });
	}
	...
	public boolean equals(Object o) {
		...
		return Objects.equals(s.getUuid(), uuid)
				...
				&& Objects.equals(s.getIsNote(), isNote)
	...
	public String toString() {
		return String.format("[subscriptionUuid:%s, updatedObjectType:%s, updatedObjectUuid:%s, isNote:%b]",
