...
public class OrganizationResource {
	...
	@Timed
	@Path("/{uuid}/tasks")
	public AnetBeanList<Task> getTasks(@PathParam("uuid") String orgUuid) {
		return new AnetBeanList<Task>(AnetObjectEngine.getInstance().getTaskDao().getTasksByOrganizationUuid(orgUuid));
	}
