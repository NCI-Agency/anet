...
public class TaskResource {
	...
	public AnetBeanList<Task> getAll(@GraphQLArgument(name="pageNum", defaultValue="0")Integer pageNum,
	...
	public AnetBeanList<Task> search(@GraphQLRootContext Map<String, Object> context, @GraphQLArgument(name="query") TaskSearchQuery query) {
	...
	public AnetBeanList<Task> recents(@GraphQLRootContext Map<String, Object> context,
		...
		return new AnetBeanList<Task>(dao.getRecentTasks(DaoUtils.getUserFromContext(context), maxResults));
	}
}
