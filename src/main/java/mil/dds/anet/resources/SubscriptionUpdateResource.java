...
public class SubscriptionUpdateResource {
	...
	public AnetBeanList<SubscriptionUpdate> getMySubscriptionUpdates(@GraphQLRootContext Map<String, Object> context, @GraphQLArgument(name="query") SubscriptionUpdateSearchQuery query) {
