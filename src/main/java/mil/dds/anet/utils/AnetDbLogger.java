...
/**
 * Logger that specifically looks for the very long column definitions that ANET2 uses
 * and will replace them in the log with a shortened version.
 * This just makes the logs easier to read and debug.
 */
public class AnetDbLogger implements SqlLogger {
	...
	public void logAfterExecution(StatementContext context) {
		final String msg = context.getRenderedSql()
