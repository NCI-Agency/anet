...
public enum FkDataLoaderKey {
  ...
  EVENT_EVENT_HOST_RELATED_OBJECTS, // event.hostRelatedObjects
  EVENT_SERIES_EVENT_SERIES_HOST_RELATED_OBJECTS, // eventSeries.hostRelatedObjects
  ...
  POSITION_PRIMARY_POSITION_FOR_PERSON_WHEN, // position.primaryPositionForPerson at a given date
