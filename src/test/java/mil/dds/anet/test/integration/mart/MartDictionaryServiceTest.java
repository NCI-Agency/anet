...
class MartDictionaryServiceTest extends AbstractResourceTest {
  ...
  void testMartDictionary() {
    ...
    assertThat(reportingTeams.get(0).get("guid")).isEqualTo("36d83805-b92b-4923-b8d1-02527fed5c78");
    ...
    assertThat(municipalities.get(0).get("albanianName")).isEqualTo("Decan");
    assertThat(municipalities.get(0).get("serbianName")).isEqualTo("Decani");
    ...
    assertThat(locations.get(0).get("albanianName")).isEqualTo("Baballoq");
    assertThat(locations.get(0).get("serbianName")).isEqualTo("Babaloc");
