...
bcp dbo.tasks OUT $outdir/tasks.bak -N  -d $DB_NAME -U $DB_USERNAME -P "$DB_PASSWORD"
...
bcp dbo.reportTasks OUT $outdir/reportTasks.bak -N  -d $DB_NAME -U $DB_USERNAME -P "$DB_PASSWORD"
