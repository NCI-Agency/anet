...
1. Seed the Database: Run ```bin/anet init```. This will show you which options this command expects; there are four values you need to supply:
    ...
    * `--adminFamilyName ADMINFAMILYNAME` i.e. _Your Family Name_: This is the family name that will be set for the ANET Administrator, who you presumably are.
    * `--adminGivenName ADMINGIVENNAME` i.e. _Your Given Name_: This is the given name that will be set for the ANET Administrator, who you presumably are.
