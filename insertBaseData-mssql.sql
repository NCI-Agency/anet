...
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
	VALUES ('00b19ebf-0d4d-4b0f-93c8-9023ccb59c49', 'SOLENOID, Selena', 0, 0, 'hunter+selena@example.com', '+1-111-1111', 'CIV', 'Selena is a test advisor in EF 1.2', 'selena', 'United States of America', 'FEMALE', DATEADD(year, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
...
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
	VALUES ('39d02d26-49eb-43b5-9cec-344777213a67', 'DVISOR, A', 0, 0, 'hunter+advisor@example.com', '+444-44-4444', 'OF-2', 'A Dvisor was born for this job', 'advisor', 'Canada', 'FEMALE', DATEADD(year, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
	VALUES (N'31cba227-f6c6-49e9-9483-fce441bea624', 'BRATTON, Creed', 0, 0, 'creed+bratton@example.com', '+444-44-4444', 'CIV', 'Let me first settle in.', 'creed', 'United States of America', 'MALE', DATEADD(year, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
	VALUES (lower(newid()), 'MALONE, Kevin', 0, 0, 'kevin+malone@example.com', '+444-44-4444', 'CIV', 'Sometimes numbers just dont add up.', 'kevin', 'United States of America', 'FEMALE', DATEADD(year, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
	VALUES (lower(newid()), 'GUIST, Lin', 0, 0, 'lin+guist@example.com', '+444-44-4444', 'CIV', 'Lin can speak so many languages', 'lin', 'United States of America', 'FEMALE', DATEADD(year, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
	VALUES (lower(newid()), 'PRETER, Inter', 0, 0, 'inter+preter@example.com', '+444-44-4444', 'CIV', 'Inter is fluent in various languages', 'inter', 'United States of America', 'MALE', DATEADD(year, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
	VALUES (lower(newid()), 'REPORTGUY, Ima', 0, 0, 'ima+reportguy@example.com', '+444-44-4545', 'CIV', 'I need a career change', 'reportguy', 'France', 'MALE', DATEADD(year, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
	VALUES (lower(newid()), 'REPORTGIRL, Ima', 0, 0, 'ima+reportgirl@example.com', '+444-44-4545', 'CIV', 'I need a career change', 'reportgirl', 'Mexico', 'FEMALE', DATEADD(year, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- Principals
...
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
	VALUES (lower(newid()), 'HALPERT, Jim', 0, 0, 'jim+halpert@example.com', '+1-412-7324', 'CIV', 'Lets prank dwight.', 'jim', 'United States of America', 'MALE', DATEADD(year, 1, CURRENT_TIMESTAMP), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
-- Administrator
INSERT INTO people (uuid, name, status, role, emailAddress, phoneNumber, rank, biography, domainUsername, country, gender, endOfTourDate, createdAt, updatedAt)
...
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+steve@example.com'), @reportUuid, 1);
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary, isAuthor)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+jack@example.com'), @reportUuid, 1, 1);
...
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+steve@example.com'), @reportUuid, 1);
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+roger@example.com'), @reportUuid, 0);
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary, isAuthor)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+jack@example.com'), @reportUuid, 1, 1);
...
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+steve@example.com'), @reportUuid, 1);
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+bob@example.com'), @reportUuid, 1);
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary, isAuthor)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+jack@example.com'), @reportUuid, 1, 1);
INSERT INTO reportTasks (taskUuid, reportUuid)
	VALUES ((SELECT uuid from tasks where shortName = '1.1.B'), @reportUuid);
...
INSERT INTO reports (uuid, createdAt, updatedAt, locationUuid, intent, text, keyOutcomes, nextSteps, state, releasedAt, engagementDate, atmosphere, atmosphereDetails, advisorOrganizationUuid, principalOrganizationUuid)
	...
	(SELECT uuid FROM organizations where shortName = 'EF 2.1'), (SELECT uuid FROM organizations WHERE longName LIKE 'Ministry of Defense'));
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+roger@example.com'), @reportUuid, 1);
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary, isAuthor)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+jack@example.com'), @reportUuid, 1, 1);
INSERT INTO reportTasks (taskUuid, reportUuid)
	VALUES ((SELECT uuid from tasks where shortName = '1.1.A'), @reportUuid);
...
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+roger@example.com'), @reportUuid, 1);
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary, isAuthor)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+liz@example.com'), @reportUuid, 1, 1);
INSERT INTO reportTasks (taskUuid, reportUuid)
...
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+christopf@example.com'), @reportUuid, 1);
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary, isAuthor)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+erin@example.com'), @reportUuid, 1, 1);
INSERT INTO reportPeople (personUuid, reportUuid, isPrimary)
	VALUES ((SELECT uuid FROM people where emailAddress='hunter+reina@example.com'), @reportUuid, 0);
INSERT INTO reportTasks (taskUuid, reportUuid)
	VALUES ((SELECT uuid from tasks where shortName = '1.1.B'), @reportUuid);
