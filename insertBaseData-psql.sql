...
INSERT INTO organizations(uuid, "shortName", "longName", "parentOrgUuid", "createdAt", "updatedAt") VALUES
  ...
  (uuid_generate_v4(), 'EF 6.2', '', (SELECT uuid FROM organizations WHERE "shortName" = 'EF 6'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (uuid_generate_v4(), 'RC-E-RLMT', 'RC-E-RLMT', '790a79f4-27f0-4289-9756-b39adce92ca7', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
  (uuid_generate_v4(), 'RC-W-RLMT', 'RC-W-RLMT', '911db213-4c01-4fa1-a781-bb1c877064f0', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
