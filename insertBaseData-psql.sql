...
INSERT INTO attachments (uuid, "authorUuid", "fileName", "caption", "mimeType", content, "contentLength", "description", "classification", "createdAt", "updatedAt")
	VALUES ('f076406f-1a9b-4fc9-8ab2-cd2a138ec26d', '87fdbc6a-3109-4e11-9702-a894d6ca31ef', 'attachReport.png', 'Arthur''s test report', 'image/png', lo_import('/var/tmp/default_avatar.png'), 12316, 'We can add attachments to a report', 'NU', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO attachments (uuid, "authorUuid", "fileName", "caption", "mimeType", content, "contentLength", "description", "classification", "createdAt", "updatedAt")
	VALUES ('f7cd5b02-ef73-4ee8-814b-c5a7a916685d', '87fdbc6a-3109-4e11-9702-a894d6ca31ef', 'attachLocation.png', 'Antarctica', 'image/png', lo_import('/var/tmp/default_avatar.png'), 12316, 'We can add attachments to a location', 'NU_rel_EU', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO "attachmentRelatedObjects" ("attachmentUuid", "relatedObjectType", "relatedObjectUuid")
...
INSERT INTO attachments (uuid, "authorUuid", "fileName", "caption", "mimeType", content, "contentLength", "description", "classification", "createdAt", "updatedAt")
	VALUES ('9ac41246-25ac-457c-b7d6-946c5f625f1f', '87fdbc6a-3109-4e11-9702-a894d6ca31ef', 'attachOrganization.png', 'EF 2.2', 'image/png', lo_import('/var/tmp/default_avatar.png'), 12316, 'We can add attachments to an organization', 'public', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO "attachmentRelatedObjects" ("attachmentUuid", "relatedObjectType", "relatedObjectUuid")
...
INSERT INTO attachments (uuid, "authorUuid", "fileName", "caption", "mimeType", content, "contentLength", "description", "classification", "createdAt", "updatedAt")
	VALUES ('13318e42-a0a3-438f-8ed5-dc16b1ef17bc', '87fdbc6a-3109-4e11-9702-a894d6ca31ef', 'attachPerson.png', 'Erin', 'image/png', lo_import('/var/tmp/default_avatar.png'), 12316, 'We can add attachments to a person', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO "attachmentRelatedObjects" ("attachmentUuid", "relatedObjectType", "relatedObjectUuid")
