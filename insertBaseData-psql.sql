...
INSERT INTO people (uuid, name, status, role, "emailAddress", "phoneNumber", rank, biography, "domainUsername", "openIdSubject", country, gender, "endOfTourDate", "createdAt", "updatedAt")
	VALUES
		(uuid_generate_v4(), 'JACKSON, Jack', 0, 0, 'hunter+jack@example.com', '123-456-78960', 'OF-9', 'Jack is an advisor in EF 2.1', 'jack', '89003390-168e-4dc3-a582-5b38ae264bdd', 'Germany', 'MALE', CURRENT_TIMESTAMP + INTERVAL '1 year', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'ELIZAWELL, Elizabeth', 0, 0, 'hunter+liz@example.com', '+1-777-7777', 'Capt', 'Elizabeth is a test advisor we have in the database who is in EF 1.1', 'elizabeth', '06547ee2-dcc3-420c-96cb-5f3bb3793b4d', 'United States of America', 'FEMALE', CURRENT_TIMESTAMP + INTERVAL '1 year', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		('00b19ebf-0d4d-4b0f-93c8-9023ccb59c49', 'SOLENOID, Selena', 0, 0, 'hunter+selena@example.com', '+1-111-1111', 'CIV', 'Selena is a test advisor in EF 1.2', 'selena', 'ce1df48e-fd6e-4dc4-bc00-9bb65a0d6910', 'United States of America', 'FEMALE', CURRENT_TIMESTAMP + INTERVAL '1 year', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		('df9c7381-56ac-4bc5-8e24-ec524bccd7e9', 'ERINSON, Erin', 0, 0, 'hunter+erin@example.com', '+9-23-2323-2323', 'CIV', 'Erin is an Advisor in EF 2.2 who can approve reports', 'erin', '04c29bab-7b20-4ff2-8583-8ad3dbcff4d6', 'Australia', 'FEMALE', CURRENT_TIMESTAMP + INTERVAL '1 year', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'REINTON, Reina', 0, 0, 'hunter+reina@example.com', '+23-23-11222', 'CIV', 'Reina is an Advisor in EF 2.2', 'reina', '5b585887-1c3d-4f47-bccb-cdfebfd6e919', 'Italy', 'FEMALE', CURRENT_TIMESTAMP + INTERVAL '1 year', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		('39d02d26-49eb-43b5-9cec-344777213a67', 'DVISOR, A', 0, 0, 'hunter+advisor@example.com', '+444-44-4444', 'OF-2', 'A Dvisor was born for this job', 'advisor', 'd09a55cf-6aa4-4bbf-8bf3-055ddcb4d27c', 'Canada', 'FEMALE', CURRENT_TIMESTAMP + INTERVAL '1 year', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(N'31cba227-f6c6-49e9-9483-fce441bea624', 'BRATTON, Creed', 0, 0, 'creed+bratton@example.com', '+444-44-4444', 'CIV', 'Let me first settle in.', 'creed', 'efad3f0d-3cd0-40fc-ac7e-90a1fa343e89', 'United States of America', 'MALE', CURRENT_TIMESTAMP + INTERVAL '1 year', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'MALONE, Kevin', 0, 0, 'kevin+malone@example.com', '+444-44-4444', 'CIV', 'Sometimes numbers just dont add up.', 'kevin', 'cf05120c-bb43-408f-93ac-609c996a9da5', 'United States of America', 'FEMALE', CURRENT_TIMESTAMP + INTERVAL '1 year', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
-- Principals
		...
		(uuid_generate_v4(), 'CHRISVILLE, Chris', 0, 1, 'chrisville+chris@example.com', '+1-412-7324', 'Maj', 'Chris is another test person we have in the database', NULL, NULL, 'Afghanistan', 'MALE', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'KYLESON, Kyle', 0, 1, 'kyleson+kyle@example.com', '+1-412-7324', 'CIV', 'Kyle is another test person we have in the database', NULL, NULL, 'Afghanistan', 'MALE', NULL, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
-- Administrator
		(uuid_generate_v4(), 'DMIN, Arthur', '0', '0', 'hunter+arthur@example.com', NULL, 'CIV', 'An administrator', 'arthur', 'abc72322-1452-4222-bb71-a0b3db435175', 'Albania', 'MALE', CURRENT_TIMESTAMP + INTERVAL '1 year', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'SCOTT, Michael', '0', '0', 'michael+scott@example.com', NULL, 'CIV', 'Worlds best boss.', 'michael', 'bd482701-2342-4a50-ba92-d956007a8828', 'United States of America', 'MALE', CURRENT_TIMESTAMP + INTERVAL '1 year', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
--People
...
INSERT INTO locations (uuid, type, name, lat, lng, "createdAt", "updatedAt")
	VALUES
		...
		(N'0855fb0a-995e-4a79-a132-4024ee2983ff', 'PPA', 'General Hospital', 47.571772, -52.741935, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(N'95446f93-249b-4aa9-b98a-7bd2c4680718', 'PPA', 'Portugal Cove Ferry Terminal', 47.626718, -52.857241, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(N'c8fdb53f-6f93-46fc-b0fa-f005c7b49667', 'PPA', 'Cabot Tower', 47.570010, -52.681770, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(N'c7a9f420-457a-490c-a810-b504c022cf1e', 'PPA', 'Fort Amherst', 47.563763, -52.680590, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(N'7339f9e3-99d1-497a-9e3b-1269c4c287fe', 'PPP', 'Harbour Grace Police Station', 47.705133, -53.214422, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
INSERT INTO positions (uuid, name, type, status, "currentPersonUuid", "locationUuid", "createdAt", "updatedAt")
	VALUES
		(uuid_generate_v4(), 'ANET Administrator', 3, 0, NULL, 'c8fdb53f-6f93-46fc-b0fa-f005c7b49667', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'EF 1 Manager', 2, 0, NULL, 'cc49bb27-4d8f-47a8-a9ee-af2b68b992ac', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'EF 1.1 Advisor A', 0, 0, NULL, 'cc49bb27-4d8f-47a8-a9ee-af2b68b992ac', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'EF 1.1 Advisor B', 0, 0, NULL, 'cc49bb27-4d8f-47a8-a9ee-af2b68b992ac', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'EF 1.1 Advisor C', 0, 0, NULL, 'cc49bb27-4d8f-47a8-a9ee-af2b68b992ac', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'EF 1.1 Advisor D', 0, 0, NULL, 'cc49bb27-4d8f-47a8-a9ee-af2b68b992ac', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'EF 1.1 Advisor E', 0, 0, NULL, 'cc49bb27-4d8f-47a8-a9ee-af2b68b992ac', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'EF 1.1 Advisor F', 0, 0, NULL, 'cc49bb27-4d8f-47a8-a9ee-af2b68b992ac', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		...
		(uuid_generate_v4(), 'EF 1.1 Advisor for Agriculture', 0, 0, NULL, 'cc49bb27-4d8f-47a8-a9ee-af2b68b992ac', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'EF 1.1 Old Inactive Advisor', 0, 1, NULL, 'cc49bb27-4d8f-47a8-a9ee-af2b68b992ac', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		...
		(uuid_generate_v4(), 'EF 4.1 Advisor on Software Engineering', 0, 0, NULL, 'c7a9f420-457a-490c-a810-b504c022cf1e', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'EF 4.1 Advisor E', 0, 0, NULL, 'c7a9f420-457a-490c-a810-b504c022cf1e', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
		(uuid_generate_v4(), 'EF 4.1 Advisor old - dont use', 0, 1, NULL, 'c7a9f420-457a-490c-a810-b504c022cf1e', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
INSERT INTO "peoplePositions" ("positionUuid", "personUuid", "createdAt")
	VALUES ((SELECT uuid from positions where name = 'EF 2.2 Final Reviewer'), (SELECT uuid from people where "emailAddress" = 'hunter+rebecca@example.com'), CURRENT_TIMESTAMP);
...
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'ANET Administrators','', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES ('70193ee9-05b4-4aac-80b5-75609825db9f', 'LNG','Linguistic', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'EF 1', 'Planning Programming, Budgeting and Execution', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 1.1', '', 0, (SELECT uuid from organizations WHERE "shortName" ='EF 1'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 1.2', '', 0, (SELECT uuid from organizations WHERE "shortName" ='EF 1'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'EF 2', '',0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 2.1', '', 0, (SELECT uuid from organizations WHERE "shortName" ='EF 2'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
...
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'EF 3', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'EF 4', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 4.1', '', 0 , (SELECT uuid FROM organizations WHERE "shortName" = 'EF 4'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 4.2', '', 0 , (SELECT uuid FROM organizations WHERE "shortName" = 'EF 4'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 4.3', '', 0 , (SELECT uuid FROM organizations WHERE "shortName" = 'EF 4'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 4.4', '', 0 , (SELECT uuid FROM organizations WHERE "shortName" = 'EF 4'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'EF 5', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
	...
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 5.2', '', 0 , (SELECT uuid FROM organizations WHERE "shortName" = 'EF 5'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 5.3', '', 0 , (SELECT uuid FROM organizations WHERE "shortName" = 'EF 5'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 5.4', '', 0 , (SELECT uuid FROM organizations WHERE "shortName" = 'EF 5'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'EF 6', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 6.1', '', 0 , (SELECT uuid FROM organizations WHERE "shortName" = 'EF 6'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
	INSERT INTO organizations(uuid, "shortName", "longName", type, "parentOrgUuid", "createdAt", "updatedAt")
		VALUES (uuid_generate_v4(), 'EF 6.2', '', 0 , (SELECT uuid FROM organizations WHERE "shortName" = 'EF 6'), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'EF7', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
...
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'TAAC-S', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'TAAC-W', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'TAAC-E', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'TAAC-C', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations(uuid, "shortName", "longName", type, "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'TAAC Air', '', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO organizations (uuid, "shortName", "longName", type, "identificationCode", "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'MoD', 'Ministry of Defense', 1, 'Z12345', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
INSERT INTO organizations (uuid, "shortName", "longName", type, "identificationCode", "createdAt", "updatedAt")
	VALUES (uuid_generate_v4(), 'MoI', 'Ministry of Interior', 1, 'P12345', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
...
INSERT INTO "peoplePositions" ("positionUuid", "personUuid", "createdAt")
	VALUES ((SELECT uuid from positions where name = 'Cost Adder - MoD'), (SELECT uuid from people where "emailAddress" = 'hunter+steve@example.com'), CURRENT_TIMESTAMP);
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+steve@example.com'), :reportuuid, TRUE);
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+steve@example.com'), :reportuuid, TRUE);
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+roger@example.com'), :reportuuid, FALSE);
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+jack@example.com'), :reportuuid, TRUE, TRUE);
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+steve@example.com'), :reportuuid, TRUE);
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+bob@example.com'), :reportuuid, TRUE);
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+jack@example.com'), :reportuuid, TRUE, TRUE);
INSERT INTO "reportTasks" ("taskUuid", "reportUuid")
	VALUES ((SELECT uuid from tasks where "shortName" = '1.1.B'), :reportuuid);
...
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "keyOutcomes", "nextSteps", state, "releasedAt", "engagementDate", atmosphere, "atmosphereDetails", "advisorOrganizationUuid", "principalOrganizationUuid")
	...
	(SELECT uuid FROM organizations where "shortName" = 'EF 2.1'), (SELECT uuid FROM organizations WHERE "longName" LIKE 'Ministry of Defense'));
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+roger@example.com'), :reportuuid, TRUE);
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+jack@example.com'), :reportuuid, TRUE, TRUE);
INSERT INTO "reportTasks" ("taskUuid", "reportUuid")
	VALUES ((SELECT uuid from tasks where "shortName" = '1.1.A'), :reportuuid);
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+roger@example.com'), :reportuuid, TRUE);
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary", "isAuthor")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+liz@example.com'), :reportuuid, TRUE, TRUE);
INSERT INTO "reportTasks" ("taskUuid", "reportUuid")
...
INSERT INTO "reportPeople" ("personUuid", "reportUuid", "isPrimary")
	VALUES ((SELECT uuid FROM people where "emailAddress"='hunter+reina@example.com'), :reportuuid, FALSE);
INSERT INTO "reportTasks" ("taskUuid", "reportUuid")
	VALUES ((SELECT uuid from tasks where "shortName" = '1.1.B'), :reportuuid);
INSERT INTO "reportsSensitiveInformation" (uuid, "createdAt", "updatedAt", text, "reportUuid")
	VALUES (uuid_generate_v4(), CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'Need to know only', :reportuuid);
...
INSERT INTO "approvalSteps" (uuid, name, "relatedObjectUuid", type)
	VALUES (uuid_generate_v4(), 'Default Approvers', (select uuid from organizations where "shortName"='ANET Administrators'), 1);
INSERT INTO approvers ("approvalStepUuid", "positionUuid")
...
INSERT INTO "adminSettings" (key, value)
	VALUES ('CONTACT_EMAIL', 'team-anet@example.com');
INSERT INTO "adminSettings" (key, value)
...
SELECT ('''' || uuid_generate_v4() || '''') AS reportuuid \gset
INSERT INTO reports (uuid, "createdAt", "updatedAt", "locationUuid", intent, text, "nextSteps", state, "engagementDate", atmosphere, "advisorOrganizationUuid", "principalOrganizationUuid")
	VALUES (:reportuuid, CURRENT_TIMESTAMP + INTERVAL '-2 day', CURRENT_TIMESTAMP + INTERVAL '-2 day', (SELECT uuid from locations where name='General Hospital'), 'Discuss further improvements in Annual Budgeting process',
...
INSERT INTO attachments (uuid, "authorUuid", "fileName", "mimeType", content, "contentLength", "description", "classification", "createdAt", "updatedAt")
	VALUES ('f076406f-1a9b-4fc9-8ab2-cd2a138ec26d', :authorUuid, 'test_attachment.png', 'image/png', lo_import('/var/tmp/default_avatar.png'), 12316, 'We can add multiple attachment for report', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
