...
INSERT INTO "eventSeries" (uuid, name, description, status, "createdAt", "updatedAt", "ownerOrgUuid", "hostOrgUuid", "adminOrgUuid") VALUES
  ('bacec3a6-f075-421e-90a0-be6e3396197c', 'Inactive test event series', 'To test that inactive event series are not shown', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
...
INSERT INTO events (uuid, name, description, status, "createdAt", "updatedAt", "locationUuid", "eventSeriesUuid", "ownerOrgUuid", "hostOrgUuid", "adminOrgUuid", "startDate", "endDate", type) VALUES
  ('7cb0fc5d-74d0-4deb-86dd-7c84761b8ac6', 'Active test event', 'To test that active events in inactive event series are not shown', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
  ...
  ('46963161-53c1-4eab-85bb-d46a03d152c4', 'Inactive test event', 'To test that inactive events are not shown', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
   NULL, 'bacec3a6-f075-421e-90a0-be6e3396197c', 'ccbee4bb-08b8-42df-8cb5-65e8172f657b', 'ccbee4bb-08b8-42df-8cb5-65e8172f657b', 'ccbee4bb-08b8-42df-8cb5-65e8172f657b',
   CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'EXERCISE'),
  ('426a8f59-98de-48eb-9e5c-bbc774f1e35f', 'NMI PDT active test event', 'NMI pre-deployment active test event', 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
   ...
   CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'OTHER'),
  ('d7c96ce1-c785-4207-abb7-20935c9a2371', 'NMI PDT inactive test event', 'NMI pre-deployment inactive test event', 1, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP,
   NULL, 'b7b70191-54e4-462f-8e40-679dd2e71ec4', 'ccbee4bb-08b8-42df-8cb5-65e8172f657b', 'ccbee4bb-08b8-42df-8cb5-65e8172f657b', 'ccbee4bb-08b8-42df-8cb5-65e8172f657b',
   CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, 'OTHER'),
