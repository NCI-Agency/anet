...
describe("Home page", () => {
  describe("When checking the notification numbers", () => {
    it("Should see that Erin has 1 counterpart and no tasks that have pending assessments", () => {
      Home.open()
    ...
    it("Should see that Jack has no counterparts and 1 task that have pending assessments", () => {
      Home.open("/", "jack")
      Home.myCounterpartsLink.waitForDisplayed()
      // eslint-disable-next-line no-unused-expressions
