...
describe("Insights pages", () => {
  it("Should open each insights page", () => {
    ...
    INSIGHTS.forEach(insight => {
      Insights.getInsightsMenu().waitForExist()
      Insights.getInsightsMenu().waitForDisplayed()
      Insights.getInsightsMenu().click()
      Insights.getInsightLink(insight).click()
      Insights.getAlert().waitForDisplayed({ timeout: 1000, reverse: true })
