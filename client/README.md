...
Flow typing is currently [not supported out of the box](https://github.com/facebook/create-react-app/issues/72) with the default `.flowconfig` generated by Flow. If you run it, you might get errors like this:
...
All `expect()` matchers supported by Jest are [extensively documented here](https://jestjs.io/docs/en/expect).<br>
You can also use [`jest.fn()` and `expect(fn).toBeCalled()`](https://jestjs.io/docs/en/expect#tohavebeencalled) to create “spies” or mock functions.
...
All Jest matchers are [extensively documented here](https://jestjs.io/docs/en/expect).<br>
