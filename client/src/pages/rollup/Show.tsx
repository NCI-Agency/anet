...
interface ChartProps {
  ...
  setOrg?: (...args: unknown[]) => unknown
  orgType?: (typeof orgTypes)[number]
  setOrgType?: (...args: unknown[]) => unknown
}
...
const Collection = ({ queryParams }: CollectionProps) => (
