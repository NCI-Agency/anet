...
const EventSeriesForm = ({ edit, title, initialValues, notesComponent }) => {
  ...
  function save(values, form) {
    const eventSeries = new EventSeries(values)
...
EventSeriesForm.propTypes = {
  initialValues: PropTypes.instanceOf(EventSeries).isRequired,
  title: PropTypes.string,
  edit: PropTypes.bool,
  notesComponent: PropTypes.node
}

EventSeriesForm.defaultProps = {
  title: "",
  edit: false
}
