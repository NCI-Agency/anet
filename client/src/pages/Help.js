    ...
    return (
      <div className="help-page">
        <Fieldset title="Need help with ANET?">
          ...
          <p>
            If you're stuck on a page and you don't know what to do, look for
            the <strong>"Take a tour"</strong> link near the top of the page.
          </p>
          <img
            src={TOUR_SCREENSHOT}
          ...
          <ul>
            ...
            {this.state.superUsers.length === 0 && (
              <em>No super users found</em>
            )}
          </ul>
