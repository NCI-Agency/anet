...
const autocompleteQuery = `${Organization.autocompleteQuery} app6context app6standardIdentity ascendantOrgs { uuid app6context app6standardIdentity } parentOrg { uuid }`
