...
const ReportsAggregatedOverTime = ({
  ...
  const displayedRangeLabel = `${getStartDate(queryParams, usePublicationDate).format(Settings.dateFormats.forms.displayShort.date)} — ${getEndDate(queryParams, usePublicationDate).format(Settings.dateFormats.forms.displayShort.date)}`
  ...
  const endOfDay = moment().endOf("day")
  const canGoNext = !usePublicationDate || rangeEnd.isBefore(endOfDay)
      ...
      <div className="p-3">
        <div className="d-flex flex-wrap align-items-center justify-content-between mb-3 gap-2">
          <div className="d-flex align-items-center gap-2">
            ...
            <Button variant="outline-secondary" onClick={() => shiftRange(-1)}>
