...
interface EntityInstantAssessmentResultsProps {
...
const EntityInstantAssessmentResults = ({
  ...
  entityType,
  periodsConfig
}: EntityInstantAssessmentResultsProps) => {
  if (!entity) {
    return null
  }
...
interface InstantAssessmentResultsTableProps {
  style?: any
  assessmentKey: string
  entity: any
  entityType: (...args: unknown[]) => unknown
...
const InstantAssessmentResultsTable = ({
  ...
  style,
  periodsDetails
}: InstantAssessmentResultsTableProps) => {
