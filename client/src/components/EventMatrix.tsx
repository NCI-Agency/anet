  ...
  useEffect(() => {
    const loadPreferences = async () => {
      try {
        ...
        const periodLengthInDaysPreference =
          currentUser.preferences.find(
            p =>
        ...
        const value =
          periodLengthInDaysPreference?.value ??
          periodLengthInDaysPreference?.defaultValue
        setPeriodLengthInDays(value)
      } catch (err) {
        console.error(err)
    ...
    <>
      ...
      <div className="float-start">
        <div className="rollup-date-range-container d-flex align-items-end gap-2">
          ...
          <Button variant="outline-secondary" onClick={() => shiftPeriod(-7)}>
            -1 week
          </Button>
          <Button variant="outline-secondary" onClick={() => shiftPeriod(-1)}>
            -1 day
          </Button>
          <Button variant="outline-secondary" onClick={() => shiftPeriod(1)}>
            +1 day
