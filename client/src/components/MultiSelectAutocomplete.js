...
export default class MultiSelectAutocomplete extends Component {
  static propTypes = {
    ...
    renderSelected: PropTypes.oneOfType([PropTypes.func, PropTypes.object])
      .isRequired, // how to render the selected items
  ...
  render() {
    ...
    const renderSelectedWithDelete = React.cloneElement(renderSelected, {
    ...
    return (
      <Field
        ...
        widget={<Autocomplete clearOnSelect {...autocompleteProps} />}
      >
