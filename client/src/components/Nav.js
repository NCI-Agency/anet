...
import {Nav as BSNav, Navbar, NavItem, NavDropdown, MenuItem} from 'react-bootstrap'
...
class Nav extends Component {
	...
	render() {
		...
		return (
			<Navbar fluid id="leftNav" className="nav-fixed">
				<Navbar.Header>
					<Navbar.Toggle />
				</Navbar.Header>
				<Navbar.Collapse>
			<BSNav bsStyle="pills" stacked pullLeft navbar>
				<Link to="/">
