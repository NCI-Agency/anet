...
const OrganizationFlowChart = ({
  ...
  const [positionsFilter, setPeopleFilter] =
    useState<PeopleFilterOption>("none")
  ...
  useEffect(() => {
    ...
    // we want to reframe whenever the width or depthLimit changes
  }, [width, depthLimit, fitView])
