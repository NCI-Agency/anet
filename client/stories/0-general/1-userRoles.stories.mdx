...
Most of the people using ANET will be regular, unprivileged users. They can search through the
...
[ANET User Stories](/docs/1-anet-user-stories-0-introduction--docs#workflows-for-advisors)
...
[ANET Superuser Stories](/docs/2-anet-superuser-stories-0-introduction--docs#workflows-for-superusers)
...
create new locations, people, organizations and tasks.
...
[ANET Admin Stories](/docs/3-anet-admin-stories-0-introduction--docs#workflows-for-administrators)
