...
permission and write permission (which includes create, update and delete). Example:
...
-   if no authorization groups for read are defined in the dictionary, user can read any instant
    assessment
...
-   if authorization groups for write are defined in the dictionary, user can create, update or
    delete instant assessments if they are in these groups

### On-demand assessments

-   admin can read, create, update and delete any on-demand assessment
-   if no authorization groups for read are defined in the dictionary, user can read any on-demand
    assessment
-   if authorization groups for read are defined in the dictionary, a user can read on-demand
    assessments if they are in these groups
-   if authorization groups for write are defined in the dictionary, a user can create, update or
    delete on-demand assessments if they are in these groups
...
-   if no authorization groups are defined in the dictionary, user can read any periodic assessment
-   if authorization groups for read are defined in the dictionary, user can read periodic
    assessments if they are in these groups
-   if authorization groups for write are defined in the dictionary, user can create, update or
    delete periodic assessments if they are in these groups

#### For a person:

-   admin can read, create, update and delete any periodic assessment
-   person has to be a user's counterpart to be able to read, create, update or delete
-   if no authorization groups for read are defined in the dictionary, user can read any periodic
    assessment
-   if authorization groups for read are defined in the dictionary, user can read periodic
    assessments if they are in these groups
-   if authorization groups for write are defined in the dictionary, user can create, update or
